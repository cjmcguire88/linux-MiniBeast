cmd_/usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o := gcc -Wp,-MD,/usr/src/linux-5.11-MiniBeast/tools/objtool/.elf.o.d -Wp,-MT,/usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o -Werror -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wshadow -Wno-switch-default -Wno-switch-enum -Wno-packed -Wno-nested-externs -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -g -I/usr/src/linux-5.11-MiniBeast/tools/include -I/usr/src/linux-5.11-MiniBeast/tools/arch/x86/include/uapi -I/usr/src/linux-5.11-MiniBeast/tools/arch/x86/include -I/usr/src/linux-5.11-MiniBeast/tools/objtool/arch/x86/include -DINSN_USE_ORC -I/usr/src/linux-5.11-MiniBeast/tools/lib -D"BUILD_STR(s)=$(pound)s" -c -o /usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o elf.c

source_/usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o := elf.c

deps_/usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o := \
...
/usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o: $(deps_/usr/src/linux-5.11-MiniBeast/tools/objtool/elf.o)
